...
@Component({
  selector: 'app-inspection-supervisor-inspection-completed',
  templateUrl: './inspection-supervisor-inspection-completed.page.html',
  styleUrls: ['./inspection-supervisor-inspection-completed.page.scss'],
})
export class InspectionSupervisorInspectionCompletedPage implements OnInit {
